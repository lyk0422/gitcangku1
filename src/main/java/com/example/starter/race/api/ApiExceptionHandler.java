...
import com.example.starter.race.service.RecordNotBetterException;
...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(RecordNotBetterException.class)
    public ResponseEntity<RecordClaimRejectedResponse> handleRecordNotBetter(
            RecordNotBetterException ex) {
        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY)
                .body(new RecordClaimRejectedResponse(
                        "UNPROCESSABLE", ex.getMessage(), ex.currentRecord()));
    }

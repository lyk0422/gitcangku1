...
public final class Dtos {
    ...
    /** 播出决定来源：PROGRAM 命中节目片段，EMERGENCY 命中紧急插播，FALLBACK 返回保底素材。 */
    public enum DecisionSource {
        PROGRAM, EMERGENCY, FALLBACK
    }
    ...
    /** 创建紧急插播请求：优先级 1～9（1 最高），区间左闭右开、同日且时长在 (0,30 分钟]。 */
    ...
    /** 紧急插播响应；status 为 ACTIVE / CANCELLED，取消时 cancelRequestId 与 cancelledAt 非空。 */

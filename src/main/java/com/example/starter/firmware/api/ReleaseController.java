...
public class ReleaseController {
    ...
    public PromoteView promote(@PathVariable long releaseId, @Valid @RequestBody PromoteRequest request) {
    ...
    public CanaryStatusView canary(@PathVariable long releaseId) {
        return canaryService.getStatus(releaseId);
    }

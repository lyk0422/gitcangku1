...
-- 合成区段目录数据，供本地启动与示例调用使用。
MERGE INTO rail_section KEY(section_id) VALUES ('SEC-DEMO-01', '示范区段一', 0);
MERGE INTO rail_section KEY(section_id) VALUES ('SEC-DEMO-02', '示范区段二', 0);
MERGE INTO rail_section KEY(section_id) VALUES ('SEC-DEMO-03', '示范区段三', 0);
